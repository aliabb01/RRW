      ...
      <table class="table table-bordered table-dark">
        <thead>
          <tr>
            ...
            <th scope="col">driver_info</th>
            <th scope="col">seats_number</th>
            <th scope="col">passengers_number</th>
        ...
        <tbody>
            ...
            <tr>
               ...
               <td> {{link_to_route('trains.edit','edit',$i,['class'=>'btn btn-success'])}}
              </td>
                <td></td>
                <td> {{link_to_route('trains.show','Delete',$i,['class'=>'btn btn-danger'])}}</td>
            </tr>
            @endforeach
        </tbody>
      </table>
      <div>
      {{link_to_route('trains.create','add a new item',null,['class'=>'btn btn-primary'])}}
      </div>
