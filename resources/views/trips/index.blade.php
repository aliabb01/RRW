  ...
  <body>
      ...
      <table class="table table-bordered table-dark">
        <thead>
          <tr>
            <th scope="col">id</th>
            <th scope="col">trip_date</th>
            <th scope="col">from</th>
            <th scope="col">to</th>
            <th scope="col">time_depart</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$i->price}}</td>
               <td> {{link_to_route('trips.edit','edit',$i,['class'=>'btn btn-success'])}}
              </td>
                <td></td>
                <td> {{link_to_route('trips.show','Delete',$i,['class'=>'btn btn-danger'])}}</td>
            </tr>
            @endforeach
        </tbody>
      </table>
      <div>
      {{link_to_route('trips.create','add a new item',null,['class'=>'btn btn-primary'])}}
      </div>
