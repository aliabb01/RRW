...
<div class="cont1">
  ...
  <div class="control-group trip-type text-center">
    <label style="user-select: none;" id="oneway-label" class="control control-radio text-success mr-3"
      data-toggle="tooltip" data-placement="left" data-delay='{"show":"1400", "hide":"200"}'
      title="For passengers who are traveling with no return ticket">
      One-way
    ...
    <label style="user-select: none;" id="fulltrip-label" class="control control-radio text-success"
      data-toggle="tooltip" data-placement="right" data-delay='{"show":"1400", "hide":"200"}'
      title="For passengers who are wishing to travel back and forth">
      Full-trip
  ...
  <div class="row labels-row" style="margin-bottom:15px; height:15px;">
    <label style="margin-left:23%; user-select: none;" id="from-label" class="text-white from-label">FROM</label>
    <label style="margin-left:8.7%; user-select: none;" id="to-label" class="text-white to-label">TO</label>
    <label class="text-light" id="departure-label" style="margin-left:7.5%; user-select: none;" for="">Departure</label>
    <label class="text-light" id="passengers-and-class-label" style="margin-left:5%; user-select: none;"
      for="">Passengers and
      Class</label>
  </div>
  <!-- Search Forms Start--------------------------------->
